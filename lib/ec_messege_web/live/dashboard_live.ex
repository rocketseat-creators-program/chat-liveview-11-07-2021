defmodule EcMessegeWeb.DashboardLive do
  require Logger

  use Phoenix.LiveView, container: {:div, [class: "row"]}
  use Phoenix.HTML

  alias EcMessegeWeb.{Auth, Chat}
  alias EcMessege.Chat.Conversation
  alias EcMessegeWeb.DashboardView
  alias EcMessegeWeb.Repo
  ...
  def mount(_params, %{"current_user" => current_user}, socket) do
    EcMessegeWeb.Endpoint.subscribe("user_conversations_#{current_user.id}")

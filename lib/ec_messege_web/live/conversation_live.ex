defmodule EcMessegeWeb.ConversationLive do
  require Logger

  use Phoenix.LiveView, layout: {EcMessegeWeb.LayoutView, "live.html"}
  use Phoenix.HTML

  alias EcMessege.{Auth, Chat, Repo}
  alias EcMessegeWeb.ConversationView
  ...
  def handle_event(
    ...
    case Chat.create_message(%{
      ...
      {:ok, new_message} ->
        ...
        EcMessage.EndPoint.broadcast!(
          "conservation_#{conversation_id}",
          "new_message",
          new_message
        )
  ...
  def handle_params(%{"conversation_id" => conversation_id, "user_id" => user_id}, _uri, socket) do
    EcMessegeWeb.Endpoint.subscribe("conversation_#{conversation_id}")
